...
/*
 * DISABLED — legacy self-service register implementation.
 *
 * Saramsa AI is currently invite-only, so /register now redirects to /signup
 * (see register/page.tsx). The original register UI is preserved here so it
 * can be restored later: to re-enable self-service signup, replace the
 * contents of register/page.tsx with the code below and delete this file.
 *
 * Next.js app router only routes files named page.tsx, so this sibling file
 * is not served or bundled as a route.
 */
...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-background text-foreground transition-colors duration-300 relative">
          ...
          >
            ...
            <div className="hidden lg:block">
              <motion.div
                ...
                className="mt-8 p-4 bg-card rounded-2xl backdrop-blur-sm border border-border shadow-[0_16px_40px_-30px_rgba(15,23,42,0.15)] dark:bg-card/80 dark:border-border/60 dark:shadow-[0_16px_40px_-30px_rgba(15,23,42,0.6)]"
              >
      ...
      {/* Right Register Form */}
      <div className="w-full md:w-full lg:w-1/2 xl:w-1/2 2xl:w-1/2 flex items-center justify-center p-2 sm:p-3 md:p-5 lg:p-5 xl:p-6 bg-card md:border-l border-border dark:border-border/60 dark:bg-card/70 relative min-h-screen md:min-h-[60vh] lg:min-h-screen">
                ...
                <div className="flex items-center gap-2">
                  <div className="relative flex-1">
                    <Input
                      ...
                      className="w-full pl-8 sm:pl-10 pr-3 py-1.5 sm:py-2 text-sm sm:text-sm md:text-sm lg:text-sm xl:text-sm 2xl:text-sm bg-background border border-border rounded-2xl focus:border-saramsa-brand/50 focus:ring-2 focus:ring-saramsa-brand/20 focus:outline-none transition-all duration-300 text-foreground placeholder:text-muted-foreground shadow-[inset_0_1px_2px_rgba(0,0,0,0.06)] dark:bg-background/80 dark:border-border/60 dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.4)]"
                    />
              ...
              <div>
                ...
                <div className="relative">
                  <Input
                    ...
                    className="w-full pl-8 sm:pl-10 pr-8 sm:pr-10 py-1.5 sm:py-2 text-sm sm:text-sm md:text-sm lg:text-sm xl:text-xs 2xl:text-base bg-background border border-border rounded-2xl focus:border-saramsa-brand/50 focus:ring-2 focus:ring-saramsa-brand/20 focus:outline-none transition-all duration-300 text-foreground placeholder:text-muted-foreground shadow-[inset_0_1px_2px_rgba(0,0,0,0.06)] dark:bg-background/80 dark:border-border/60 dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.4)]"
                  />
