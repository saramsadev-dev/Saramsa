...
CORS_ALLOWED_ORIGINS = [
    ...
    'https://saramsa-celery-dxe4e5h5f0hbctdw.australiacentral-01.azurewebsites.net',
    'https://saramsa-backend-d4fyc3b7dsbve5fw.australiacentral-01.azurewebsites.net',
    'http://localhost:3000',      
    'http://localhost:8000',
    'http://localhost',
]
