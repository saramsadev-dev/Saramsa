...
from feedback_analysis.views import UserStoriesView, AnalyzeCommentsView, TaskStatusView, TaskListView, GetUserCommentsView, FeedbackFileUploadView, FeedbackFileIngestView
...
urlpatterns = [
    ...
    path('api/insights/ingest/', FeedbackFileIngestView.as_view(), name='insights_ingest'),
